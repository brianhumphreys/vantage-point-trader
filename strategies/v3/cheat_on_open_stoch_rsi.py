...
class CheatOnOpenStochRsi(bt.Strategy):
    params = dict(
        stochrsi_period=14,
        overbought=0.8,
        oversold=0.2,
    ...
    def operate(self, d):
        ...
        if not self.o.get(d, None):  # no market / no orders
            ...
            stochrsi_array = self.stochrsi[d._name].stochrsi.array
            print(stochrsi_array)
            stochrsi_ind = stochrsi_array[len(stochrsi_array) - 1]
...
def runStrat(args=None):
    ...
    strategy = 'cheat-on-open-stoch-rsi'
